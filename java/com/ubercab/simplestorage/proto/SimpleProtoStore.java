package com.ubercab.simplestorage.proto;
...
public final class SimpleProtoStore implements SimpleStore {
    private final SimpleStore simpleStore;

    private SimpleProtoStore(SimpleStore simpleStore) {
        this.simpleStore = simpleStore;
    }

    public static SimpleProtoStore create(Context context, String scope, ScopeConfig config) {
        return new SimpleProtoStore(SimpleStoreImplFactory.create(context, scope, config));
    }
