...
public class AtomicFileTest {
  ...
  @Nullable public final String[] mExistingFileNames;
  @Nullable public final WriteAction mWriteAction;
  @Nullable public final byte[] mExpectedBytes;

  public AtomicFileTest(
      @NonNull String unusedTestName,
      @Nullable String[] mExistingFileNames,
      @Nullable WriteAction mWriteAction,
      @Nullable byte[] mExpectedBytes) {
  ...
  public static List<Object[]> data() {
    return Arrays.asList(
        new Object[][] {
          ...
          {"base + finish = new", new String[] {BASE_NAME}, WriteAction.FINISH, NEW_BYTES},
          {"base + fail = base", new String[] {BASE_NAME}, WriteAction.FAIL, BASE_BYTES},
          {"base + abort = base", new String[] {BASE_NAME}, WriteAction.ABORT, BASE_BYTES},
          ...
          {"bak + none = bak", new String[] {LEGACY_BACKUP_NAME}, null, LEGACY_BACKUP_BYTES},
          {"bak + finish = new", new String[] {LEGACY_BACKUP_NAME}, WriteAction.FINISH, NEW_BYTES},
          {
            "bak + fail = bak",
            new String[] {LEGACY_BACKUP_NAME},
            WriteAction.FAIL,
            LEGACY_BACKUP_BYTES
          },
          {
          ...
          {"base & new + none = base", new String[] {BASE_NAME, NEW_NAME}, null, BASE_BYTES},
          {
            "base & new + finish = new",
            new String[] {BASE_NAME, NEW_NAME},
            WriteAction.FINISH,
            NEW_BYTES
          },
          {
          ...
          {
            "base & bak + none = bak",
            new String[] {BASE_NAME, LEGACY_BACKUP_NAME},
            null,
            LEGACY_BACKUP_BYTES
          },
          {
          ...
          {
            "new & bak + none = bak",
            new String[] {NEW_NAME, LEGACY_BACKUP_NAME},
            null,
            LEGACY_BACKUP_BYTES
          },
          {
          ...
          {
            "base.dir + finish = new",
            new String[] {BASE_NAME_DIRECTORY},
            WriteAction.FINISH,
            NEW_BYTES
          },
          {"base.dir + fail = none", new String[] {BASE_NAME_DIRECTORY}, WriteAction.FAIL, null},
          {"base.dir + abort = none", new String[] {BASE_NAME_DIRECTORY}, WriteAction.ABORT, null},
          {
            "base.dir & new + none = none", new String[] {BASE_NAME_DIRECTORY, NEW_NAME}, null, null
          },
          {
            "base.dir & new + finish = new",
            new String[] {BASE_NAME_DIRECTORY, NEW_NAME},
            WriteAction.FINISH,
            NEW_BYTES
          },
          {
  ...
  public static <T extends Throwable> T assertThrows(
      @NonNull Class<T> expectedType, @NonNull ThrowingRunnable runnable) {
    try {
      runnable.run();
    } catch (Throwable t) {
    ...
    throw new AssertionError(
        String.format("Expected %s wasn't thrown", expectedType.getSimpleName()));
  }
